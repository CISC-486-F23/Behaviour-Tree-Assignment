...
public class Shoot : MonoBehaviour {
    ...
    void Update() {
        ...
        if (heldOn && wait && Time.timeScale!=0 && Loaded && !reloading) {
            ShootBullet();
            startTime = Time.time;
        ...
        if ((remainingBulletsInCartridge == 0 && heldOn) &&
            !reloading &&
            remainingBulletsInCartridge < cartridgeSize &&
    ...
    public bool Loaded
    {
        get { return remainingBulletsInCartridge > 0; }
    }

    public bool FullyLoaded
    {
        get { return remainingBulletsInCartridge == cartridgeSize; }
    }

    public bool OutOfAmmo
    {
        get { return remainingBulletsTotal <= 0; }
    }
}
